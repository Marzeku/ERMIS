...
<html>
	...
	<?php include '../Vista/Inicio_Con.php'; ?>
			<ul class="nav navbar-nav">
				<li style="top:1px;left:-120px;"><a href="../Vista/Buscar1_Pro.php"><span class="glyphicon glyphicon-modal-window"></span><font size=3 face="Times New Roman, arial"> Volver </font></a></li>
			</ul>
		</div>
        </div>
...
public static function consultar()
{
	...
	$ID = $_POST["ID"];
		    ...
		    <font face = "Candara">
		        <div class align = "right"></h4>
	             ...
	             <form method="post" action = "../Vista/Buscar2_Pro.php">
		            <input type = "hidden" id="ID" name="ID" value = <?php echo $ID ?>>
		            <input style="float:center;" value="Consultar por Nombre" type="submit" id="Consultar_P" name="Consultar_P" class="btn btn-success btn-lg"></b></h4>
	             </form>
	             </div>
	             </div>
	             </div>
	    ...
	    else
	    {
	        ...
	        if (resultado.value)
	        {
                Swal.fire(console.log(window.location = "../Vista/Buscar1_Pro.php"));
	        }
	        });
            ...
            <a href="../Vista/Buscar1_Pro.php"><button class="btn btn-success" id="Volver" width="700px" height="100px"><font size=3 face="Verdana"><b> Volver </b></font></button></a>
