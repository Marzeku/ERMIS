					...
					<form method="post" action = "../Modelo/Cambiar_Pro.php" enctype="multipart/form-data">
						<div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" style="font-family: Cambria; font-size: 13pt;" id="iva" placeholder = "Digite un valor sin porcentaje" maxlength="4" name="iva" value="<?php echo ($IVA * 100) ?>" min="0" onkeypress="return (event.charCode >= 46)" oninput="this.value = Math.abs(this.value)" class="form-control">
                                <p>
                            </div>
                            <div class="col-md-4">
								<p></p><label for="descuento">Descuento (%)</label> <p></p>
                                <input type="text" style="font-family: Cambria; font-size: 13pt;" placeholder = "Descuento" maxlength="4" placeholder = "Digite un valor sin porcentaje" id="descuento" name="descuento" value="<?php echo ($Descuento * 100); ?>" min="0" onkeypress="return (event.charCode >= 46)" oninput="this.value = Math.abs(this.value)" class="form-control">
                                <p>
                            </div>
                        </div>
                        <p><br/></p>
