...
<audio id = "Password" src = "../music/Password.mp3" autoplay = "autoplay" loop = "loop"></audio>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading">Verificar credenciales</div>
					<div class="panel-body">
					
					<form method="post" action = "Cambiar_Con.php">
						<div class="row">
							<div class="col-md-12">
                            ...
                            <div class="col-md-12">
								<label for="clave">Clave secundaria</label> <br>
