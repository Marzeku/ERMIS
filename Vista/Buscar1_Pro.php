		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading"><b>Consultar producto por Identificación</b></div>
					...
					<div class="row">
						...
						<div class="col-md-1">
							<form method="post" action = "../Vista/Buscar2_Pro.php">
								<input style="float:center;" value="Consultar por Nombre" type="submit" id="Consultar_P" name="Consultar_P" class="btn btn-primary btn-lg">
							</form>
							</font>
						</div>	
					</div>
					...
					<form method="post" action = "../Controlador/Consultar1_Pro.php">
						<div class="row">
							<div class="col-md-12">
							<p></p>
