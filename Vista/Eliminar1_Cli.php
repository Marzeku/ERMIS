		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading"><b>Eliminar un usuario</b></div>
					<div class="panel-body">
					
					<form method="post" action = "../Controlador/Eliminar_Cli.php">
						<div class="row">
							<div class="col-md-12">
                                <label for="ID">ID</label>
                                <input type="number" id="ID" name="ID" required = "required" min="0" oninput="this.value = Math.abs(this.value)" class="form-control">
                            </div>
                        </div>
                        <p><br/></p>
						<div class="row">
							<div class="col-md-12">
								<input style="float:right;" value="Siguiente" type="submit" id="Siguiente" name="Siguiente"  class="btn btn-success btn-lg">
							</div>
						</div>
