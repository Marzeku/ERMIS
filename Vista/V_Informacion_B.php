...
<p><br/></p>
	 ...
	 <table width="90%" cellspacing="3" cellpadding="3" align="center" style="margin: 0 auto;"> <!-- #22142b -->
          ...
          <tr>
            ...
            <td bgcolor = "#1e1e24"><p></p>&nbsp;&nbsp;&nbsp;<font face="Times New Roman, arial" size="4" color = "white"><center><b>Una puerta trasera es una secuencia especial o un término trasero dentro del código de programación, mediante la cual se pueden evitar los sistemas de seguridad del algoritmo para acceder al sistema. 
            <p></p>A menudo, las puertas traseras se introducen en el sistema gracias a otros programas nocivos como troyanos, virus o incluso spyware. Consiguen acceso sin que el administrador se dé cuenta y luego infectan las sesiones a cada uno de los usuarios conectados a la red comprometida. Es posible que algunas amenazas puedan ser colocadas con carácter previo por usuarios que tienen los privilegios adecuados, para ganar acceso más tarde.
            <font face="Times New Roman, arial" size="4" color = "white"><center><b>&nbsp;&nbsp;&nbsp;<font face="Times New Roman, arial" size="5"><center><b><iframe allowfullscreen="" class="BLOG_video_class" height="333" src="https://www.youtube.com/embed/iJR7IUGZJz8" width="483" youtube-src-id="iJR7IUGZJz8"></iframe></p><p></p><p style="text-align: left;"></p><p class="MsoNormal" style="line-height: 150%; text-align: justify;"><span style="color: #0d0d0d; font-family: &quot;Times New Roman&quot;,serif; font-size: 12pt; line-height: 150%; mso-themecolor: text1; mso-themetint: 242;"></b></center></font> 
            <p></p>&nbsp;&nbsp;&nbsp;El uso de Backdoors en la actualidad suele verse integrado dentro de los troyanos. Gracias a esta usabilidad, un atacante puede conectarse siempre que quiere a los sistemas infectados, actualizar o cambiar los malware instalados para que realicen todo tipo de actividades o robar información sin que el usuario se dé cuenta, entre otras cosas.
            <p></p>&nbsp;&nbsp;&nbsp;Tambien hay que señalar que no todos los Backdoors presentes en sistemas y aplicaciones tienen por que ser peligrosos, puesto que muchos estan instalados a proposito para realizar tareas de mantenimiento o actualizacion en un dispositivo. Siempre que esten bien configurados y solo permitan el paso de usuarios legítimos, no habrá problemas.
            <p></p>&nbsp;&nbsp;&nbsp;Se sabe que los delincuentes no tienen escrúpulos a la hora de explotar cualquier herramienta a su alcance para conseguir su objetivo (fundamentalmente, dinero) e incluso han habido casos en los que se han estado aprovechando de fallos de seguridad que permitian utilizar una puerta trasera en ciertas aplicaciones o sistemas en su propio beneficio.
