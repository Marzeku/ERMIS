...
<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="../Vista/Suprimir_Pro.php"><span class="glyphicon glyphicon-modal-window"></span><font size=3 face="Times New Roman, arial"> Volver </font></a></li>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading"><b>Eliminar por Nombre</b></div>
					<div class="panel-body">
					<br>
					<center>
					<font face = "Candara">
						<form method="post" action = "../Vista/Eliminar1_Pro.php">
							<input style="float:center;" value="Eliminar por Identificación" type="submit" id="Eliminar_ID" name="Eliminar_ID" class="btn btn-warning btn-lg">
						</form>
					</font>
					</center>
					<br>
					...
					<form method="post" action = "../Controlador/Eliminar_Pro.php">
						<div class="row">
                            ...
                            <font face = "Candara">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input style="float:center;" value="Eliminar" type="submit" id="Eliminar" name="Eliminar" class="btn btn-success btn-lg">
							</font>
                            </div>
