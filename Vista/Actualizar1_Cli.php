...
<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="../Vista/Clientes.php"><span class="glyphicon glyphicon-modal-window"></span><font size=3 face="Times New Roman, arial"> Volver </font></a></li>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading"><b>Actualizar un usuario</b></div>
					<div class="panel-body">
					
					<form method="post" action = "../Controlador/Actualizar_Cli.php">
						<div class="row">
							<div class="col-md-12">
							<p></p>
							<label for="nombre">ID</label><p></p>
                            <select menu = "ID" id = "ID" name = "ID" required = "required" style="width : 720px; height : 50px;" class="form-control">
                            ...
                            <font face = "Candara">
								<input style="float:right;" value="Consultar" type="submit" id="Consultar" name="Consultar" class="btn btn-success btn-lg">
							</font>
                            </div>
                        </div>
                        <p><br/></p>
