		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading"><b>Eliminar por Identificación</b></div>
					<div class="panel-body">
					<br>
					<center>
					<font face = "Candara">
						<form method="post" action = "../Vista/Eliminar2_Pro.php">
							<input style="float:center;" value="Eliminar por Nombre" type="submit" id="Eliminar_N" name="Eliminar_N" class="btn btn-danger btn-lg">
						</form>
					</font>
					</center>
					<br>
