		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading"><b><font face = "Palatino" size="5"><center>Eliminación de Producto</center></font></b></div>
					...
					<div class="row">
						<div class="col-md-5">
							 <a href="../Vista/Eliminar1_Pro.php"><figure><img src="../product_images/EliminarID_Pro.png" alt = "Eliminar por ID" title = "Eliminar por ID" height=420 width=310 style="filter:alpha(opacity=50); opacity:.5" onmouseover="ilumina(this)" onmouseout="apaga(this)"></figure></a>
						</div>
						<div class="col-md-1">
							<a href="../Vista/Eliminar2_Pro.php"><figure><img src="../product_images/EliminarNom_Pro.png" alt = "Eliminar por Nombre" title = "Eliminar por Nombre" height=420 width=320 style="filter:alpha(opacity=50); opacity:.5" onmouseover="ilumina(this)" onmouseout="apaga(this)"></figure></a>
						</div>
					</div>
					</div>
					</div>
