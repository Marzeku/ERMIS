		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading"><b>Actualizar por identificación</b></div>
					<div class="panel-body">
					<br>
					<center>
					<font face = "Candara">
						<form method="post" action = "../Vista/Actualizar2_Pro.php">
							<input style="float:center;" value="Actualizar por Nombre" type="submit" id="Actualizar_N" name="Actualizar_N" class="btn btn-primary btn-lg">
						</form>
					</font>
					</center>
